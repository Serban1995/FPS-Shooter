   ...
   // public GameObject bullet;
    ...
    void Update()
    {
        ...
        if (!UIController.instance.pauseScreen.activeInHierarchy && !GameManager.instance.levelEnding)
        {
            ...
            camTras.rotation = Quaternion.Euler(camTras.rotation.eulerAngles + new Vector3(-mouseInput.y, 0f, 0f));
            ...
            {
                RaycastHit hit;
                if (Physics.Raycast(camTras.position, camTras.forward, out hit, 500f))
                {
            ...
            UIController.instance.currentAmmoText.text = "Ammo:" + activeGun.currentAmmo;
        }
